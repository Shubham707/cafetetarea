...
--
-- Host: localhost
-- Generation Time: Sep 08, 2018 at 05:58 PM
...
CREATE TABLE `restaurant` (
  ...
  `user_id` int(11) NOT NULL,
  `res_table` varchar(150) NOT NULL,
  `res_seat` varchar(200) NOT NULL,
  `res_servise` varchar(100) DEFAULT NULL,
  `res_date_and_time` varchar(100) NOT NULL,
  `order_close` int(11) NOT NULL,
  `status` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
