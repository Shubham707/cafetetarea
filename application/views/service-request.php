                     ...
                     <div class="profile-section margin-bottom-20">
                        <div class="profile-tabs">
                           <ul class="nav nav-justified nav-tabs">
                              <li id="bd" class="active"><a>Bike Details</a></li>
                              <li class="sr"><a>Service Details</a></li>
                              <li class="pd"><a>Personal Details</a></li>
                              ...
                              <div class="profile-edit tab-pane fade" id="edit">
                                 ...
                                 <form>
								  ...
								  <div class="col-md-4 col-sm-4 col-xs-12">
									  <a id="pd" href="#payment" data-toggle="tab"><button class="btn btn-theme btn-sm">Update &amp; Continue</button></a>
								   </div>
