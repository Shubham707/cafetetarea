...
<head>
  ...
  <title>Admin | ForgetPassword in</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        <input type="email" class="form-control" name="admin_name" placeholder="Email Or Mobile">
      ...
      <div class="row">
        ...
        <div class="col-xs-offset-2 col-xs-4">
          <a class="btn btn-danger" href="<?php echo base_url('admin/login')?>">Log In</a>
        </div>
        <!-- /.col -->
      </div>
    </form>
